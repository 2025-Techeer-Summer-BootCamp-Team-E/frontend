...
const FrontCharacterCard: React.FC<FrontProps> = ({name, sex}) => {
    ...
    return (
        <div className="w-[264px] h-[300px] mb-4 flex items-center justify-center rounded-md relative">
            <span className="absolute top-2 left-2 font-bold text-m" style={{writingMode: 'vertical-rl', textOrientation: 'upright', letterSpacing: '0.2em', }}>{name}</span>
