...
const VideoInfo: React.FC<VideoInfoProps> = ({imageUrl, title, from, character, description}) => {
    return (
        <div className="w-[1206px] [h-256px] flex rounded-[16px] border border-gray-300 bg-white shadow-md overflow-hidden max-w-3xl">
            {/* 왼쪽: 이미지 */}
            ...
            <div className="flex flex-col justify-center flex-1 gap-2">
                ...
                <div className="w-[700px] h-[86px] rounded-[12px] bg-gray-100 px-2">
